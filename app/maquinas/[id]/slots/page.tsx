...
import { AppShell, PageHeader, ConfirmActionDialog } from '@/components/ui-custom';
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        subtitle={selectedMachine ? `Máquina: ${selectedMachine.name}` : 'Slots de la máquina'}
        backHref={`/maquinas/${machineId}`}
        variant="white"
        actions={
          <Link
            href={`/maquinas/${machineId}/slots/crear`}
                ...
                >
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Link
                        href={`/maquinas/${machineId}/slots/${slot.id}/editar`}
      ...
      {/* Stock Update Modal (custom form dialog) */}
      {stockUpdateSlot && (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
            ...
            <div className="flex items-center space-x-4">
              <button
                onClick={() => setStockUpdateSlot(null)}
      ...
      <ConfirmActionDialog
        ...
        title="Eliminar Slot"
        description={`¿Estás seguro de que deseas eliminar el slot ${slotToDelete?.label || slotToDelete?.mdb_code}? Esta acción no se puede deshacer.`}
