...
import { Save, Loader2, CheckCircle, XCircle, Package } from 'lucide-react';
...
export default function CreateSlotPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (createdSlot) {
      ...
      setTimeout(() => {
        router.push(`/maquinas/${machineId}/slots`);
      }, 1500);
    }
  };
    ...
    <AppShell>
      ...
      <main className="flex-1 p-4 sm:p-6 overflow-auto">
        <div className="max-w-2xl mx-auto">
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6" suppressHydrationWarning>
