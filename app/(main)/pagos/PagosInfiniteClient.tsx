...
const PAGOS_TOUR_STEPS: Step[] = [
  {
    ...
    popover: {
      title: 'Modo en vivo',
      description: '<p>Activa el <b>Modo en vivo</b> para recibir cada pago al instante por MQTT, sin recargar la página.</p><p>Configura cuánto tiempo se muestran los pagos recientes (30 s, 1 min, 5 min) y filtra por empresa si lo necesitas.</p>',
      side: 'bottom',
      align: 'end',
    },
  },
  {
    ...
    popover: {
      ...
      description: '<p>Combina filtros para encontrar exactamente lo que buscas:</p><p>• Texto libre, estado (exitoso / rechazado), empresa, máquina.</p><p>• Rango de fechas con selector de inicio y fin.</p>',
      side: 'bottom',
      align: 'start',
    },
  },
  {
    ...
    popover: {
      ...
      description: '<p>Cada fila muestra el producto, monto, estado y máquina del pago.</p><p>Haz clic en <b>Ver detalle</b> para abrir el panel lateral con todos los datos de la transacción, incluyendo datos de tarjeta y respuesta del sistema.</p>',
      side: 'top',
      align: 'start',
    },
  },
