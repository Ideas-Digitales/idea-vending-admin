...
interface ProductosMetricsPanelProps {
...
export default function ProductosMetricsPanel({ enterpriseId, period }: ProductosMetricsPanelProps) {
  ...
  return (
    <div data-tour="product-metrics" className="space-y-4">
      {/* Lista compacta */}
      <div data-tour="product-list" className="card overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <ShoppingCart className="h-4 w-4 text-primary" />
            <span className="text-sm font-semibold text-dark">Ventas por producto · {PERIOD_LABELS[period]}</span>
          </div>
        </div>
