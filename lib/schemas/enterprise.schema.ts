...
// Schema para crear una nueva empresa (todos los campos requeridos)
...
// Schema para validar solo campos que no están vacíos en actualización
export const updateEnterpriseSchemaPartial = updateEnterpriseSchema.partial().refine(
